...
class ReportController extends Controller
{
    public function transaction()
    {
        ...
        $transactions = Transaction::with('user','restaurant')->orderBy('id','desc')->paginate(getPaginate());
    ...
    public function transactionSearch(Request $request)
    {
        ...
        $transactions = Transaction::with('user','restaurant')->whereHas('user', function ($user) use ($search) {
