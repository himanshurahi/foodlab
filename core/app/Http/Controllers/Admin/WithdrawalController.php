...
class WithdrawalController extends Controller
{
    ...
    public function details($id)
    {
        ...
        if ($withdrawal->restaurant_id) {
            $pageTitle = $withdrawal->restaurant->username.' Withdraw Requested ' . showAmount($withdrawal->amount) . ' '.$general->cur_text;
        }
    ...
    public function approve(Request $request)
    {
        ...
        if ($withdraw->restaurant_id) {
            notify($withdraw->restaurant, 'WITHDRAW_APPROVE', [
                'method_name' => $withdraw->method->name,
                'method_currency' => $withdraw->currency,
                'method_amount' => showAmount($withdraw->final_amount),
                'amount' => showAmount($withdraw->amount),
    ...
    public function reject(Request $request)
    {
        ...
        if ($withdraw->restaurant_id) {
            ...
            $restaurant = Restaurant::find($withdraw->restaurant_id);
            ...
            notify($restaurant, 'WITHDRAW_REJECT', [
                'method_name' => $withdraw->method->name,
                'method_currency' => $withdraw->currency,
                'method_amount' => showAmount($withdraw->final_amount),
                'amount' => showAmount($withdraw->amount),
