...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Restaurant Info
        $widget['total_restaurants'] = Restaurant::count();
        $widget['verified_restaurants'] = Restaurant::where('status', 1)->count();
        $widget['email_unverified_restaurants'] = Restaurant::where('ev', 0)->count();
        $widget['sms_unverified_restaurants'] = Restaurant::where('sv', 0)->count();
    ...
    public function notifications(){
        $notifications = AdminNotification::orderBy('id','desc')->with('user','restaurant')->paginate(getPaginate());
