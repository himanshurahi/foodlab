@php
    $restaurants = App\Models\Restaurant::where('status',1)->where('open_time','!=',null)->where('close_time','!=',null)->where('days','!=',null)->where('d_time','>',0)->limit('12')->whereHas('categories',function($q){
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12">
                <div class="section-header">
                    <h2 class="section-title">@lang('Our Restaurants')</h2>
                    <div class="see-all-btn">
                        <a href="{{route('our.restaurants')}}" class="custom-btn">@lang('See all restaurants') <i class="las la-angle-double-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
