                        ...
                        <div class="card card-deposit custom--card">
                            ...
                            <div class="card-footer text-center">
                                <a href="javascript:void(0)" data-id="{{$data->id}}"
                                   ...
                                   data-percent_charge="{{showAmount($data->percent_charge)}}" class="btn--base deposit w-100" data-bs-toggle="modal" data-bs-target="#depositModal">
                                    @lang('Deposit Now')</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('user.deposit.insert')}}" method="post">
                    ...
                    <div class="modal-body">
                        <p class="text--success depositLimit mb-0"></p>
