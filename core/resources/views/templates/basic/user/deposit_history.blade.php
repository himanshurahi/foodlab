                                ...
                                @if(count($logs) >0)
                                    @foreach($logs as $k=>$data)
                                        <tr>
                                            ...
                                            <td>
                                                @if($data->status == 1)
                                                    <span class="badge badge--success text-white">@lang('Complete')</span>
                                                @elseif($data->status == 2)
                                                    <span class="badge badge--warning text-white">@lang('Pending')</span>
                                                @elseif($data->status == 3)
                                                    <span class="badge badge--danger text-white">@lang('Cancel')</span>
                                                @endif
                                            ...
                                            <td data-label="@lang('Time')">
                                                <i class="fa fa-calendar text--base me-2"></i> {{showDateTime($data->created_at)}}
                                            </td>
                                            ...
                                            <td data-label="@lang('Details')">
                                                <a href="javascript:void(0)" class="btn btn--base approveBtn"
                                                data-info="{{ $details }}"
                                                data-id="{{ $data->id }}"
