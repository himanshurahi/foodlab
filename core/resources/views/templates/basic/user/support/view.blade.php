                ...
                <div class="col-md-12">
                    <div class="card custom--card">
                        <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <button class="btn btn--base close-button" type="button" title="@lang('Close Ticket')" data-bs-toggle="modal" data-bs-target="#DelModal"><i class="fa fa-lg fa-times-circle"></i>
                            </button>
                        </div>
                        <div class="card-body">
                                                    ...
                                                    <div class="row justify-content-between">
                                                        <div class="col-md-8">
                                                            <div class="row justify-content-between">
                                                                ...
                                                                <div class="col-md-1">
                                                                    <div class="form-group">
                                                                        <a href="javascript:void(0)" class="btn btn--base btn-round mt-4 addFile">
            ...
            <div class="modal-content">
                <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn--base btn-sm" data-bs-dismiss="modal"><i class="fa fa-times"></i>
                            @lang('Close')
                        </button>
                ...
                $("#fileUploadsContainer").append(
                    `<div class="input-group">
                        ...
                        <div class="input-group-append support-input-group">
                            <span class="input-group-text btn btn--base support-btn remove-btn">&times;</span>
                        </div>
                    </div>`
                )
            });
