    ...
    <section class="account-section ptb-60">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-10 col-lg-10 col-md-10 colo-sm-12">
                        ...
                        <form class="account-form" action="{{ route('user.register') }}" method="POST" onsubmit="return submitUserForm();">
                            ...
                            <div class="row ml-b-20">
                                ...
                                <div class="col-lg-6 form-group hover-input-popup">
                                    ...
                                    <input type="password" class="form-control form--control" name="password" id="password" required>
                                ...
                                @if($general->agree)
                                    <div class="col-lg-12 form-group">
                                        <div class="form-group custom-check-group">
                                            ...
                                            <label for="agree">@lang('I have read agreed with the')
                                ...
                                <div class="col-lg-12 form-group text-center">
                                    <button type="submit" id="recaptcha" class="submit-btn">@lang('Register Now')</button>
                                </div>
      ...
      "use strict";
        function submitUserForm() {
            ...
            if (response.length == 0) {
                document.getElementById('g-recaptcha-error').innerHTML = '<span class="text--base">@lang("Captcha field is required.")</span>';
                return false;
            }
            return true;
        }
