    ...
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="{{asset('assets/admin/images/1.jpg')}}">
            <div class="form-wrapper">
                ...
                <form action="{{ route('restaurant.password.verify.code') }}" method="POST" class="cmn-form mt-30">
                    @csrf
                    ...
                    <div class="form-group d-flex justify-content-between align-items-center">
                        <a href="{{ route('restaurant.password.reset') }}" class="text-muted text--small">@lang('Try to send again')</a>
                    </div>
