...
@section('panel')
        ...
        <div class="col-lg-12 col-md-12 mb-30">
            <div class="card">
                                ...
                                @forelse ($foods as $item)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            ...
                                            <a href="javascript:void(0)" class="icon-btn updateBtn"  data-route="{{ route('restaurant.category.food.update',$item->id) }}" data-resourse="{{$item}}" data-toggle="modal" data-target="#updateBtn" data-image="{{ getImage(imagePath()['food']['path'].'/'. $item->image,imagePath()['food']['size'])}}" ><i class="la la-pencil-alt"></i></a>
                ...
                <div class="card-footer py-4">
                    {{ $foods->links('restaurant.partials.paginate') }}
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="addModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('restaurant.category.food.store',$category->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <textarea name="details" class="check-length" data-length="191" placeholder="@lang('Enter Food Details')" rows="4">{{ old('details') }}</textarea>
                        ...
                        <div class="form-group">
                            <b>@lang('Food Image') <span class="text-danger">*</span></b>
                ...
                <form action="" class="edit-route" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                <label class="form-control-label font-weight-bold">@lang('Details') <span class="text-danger">*</span></label>
                                <textarea name="details" class="check-length details" data-length="191" placeholder="@lang('Enter Food Details')" rows="4"></textarea>
                                <span class="remaining float-right"> @lang('191 characters remaining')</span>
                            </div>
                        </div>
    ...
    <div id="activateModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('restaurant.category.food.activate') }}" method="POST">
                    @csrf
    ...
    <div id="deactivateModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('restaurant.category.food.deactivate') }}" method="POST">
                    @csrf
                    <input type="hidden" name="id">
                    <div class="modal-body">
    ...
    @push('breadcrumb-plugins')
        ...
        @if(request()->routeIs('restaurant.category.food'))
            <form action="{{ route('restaurant.category.food.search',$category->id) }}" method="GET" class="form-inline float-sm-right bg--white mt-2">
