...
@section('panel')
        ...
        <div class="col-lg-12 col-md-12 mb-30">
            <div class="card">
                                ...
                                @forelse ($categories as $item)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            ...
                                            <a href="{{ route('restaurant.category.food',$item->id) }}" class="icon-btn btn--info mr-1" data-toggle="tooltip" title="@lang('Manage Food')" data-original-title="@lang('Manage Food')">
                                                <i class="las la-utensils text--shadow"></i>
                                            </a>

                                            <a href="javascript:void(0)" class="icon-btn updateBtn"  data-route="{{ route('restaurant.category.update',$item->id) }}" data-resourse="{{$item}}" data-toggle="modal" data-target="#updateBtn" ><i class="la la-pencil-alt"></i></a>
                ...
                <div class="card-footer py-4">
                    {{ $categories->links('restaurant.partials.paginate') }}
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="activateModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('restaurant.category.activate') }}" method="POST">
                    @csrf
    ...
    <div id="deactivateModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('restaurant.category.deactivate') }}" method="POST">
                    @csrf
                    <input type="hidden" name="id">
                    <div class="modal-body">
    ...
    @push('breadcrumb-plugins')
        ...
        @if(request()->routeIs('restaurant.category'))
            <form action="{{ route('restaurant.category.search') }}" method="GET" class="form-inline float-sm-right bg--white mt-2">
