                ...
                @if ($deposit->order_id)
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            ...
                            @foreach($deposit->order->details as $item)
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Subtotal')
                                <span class="font-weight-bold">{{ showAmount($deposit->order->sub_total) }} {{$general->cur_text}}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Delivery Charge')
                                <span class="font-weight-bold">{{ showAmount($deposit->order->d_charge) }} {{$general->cur_text}}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Vat')
                                <span class="font-weight-bold">{{ showAmount($deposit->order->vat) }} {{$general->cur_text}}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Discount')
                                <span class="font-weight-bold">{{ showAmount($deposit->order->discount) }} {{$general->cur_text}}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Total')
                                <span class="font-weight-bold">{{ showAmount($deposit->order->total) }} {{$general->cur_text}}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Status')
                                @if($deposit->order->status == 1)
                                    <span class="badge badge-pill bg--success">@lang('Confirmed')</span>
                                @elseif($deposit->order->status == 2)
                                    <span class="badge badge-pill bg--success">@lang('Deliverd')</span>
                                @elseif($deposit->order->status == 3)
                                    <span class="badge badge-pill bg--danger">@lang('Canceled')</span>
                                @elseif($deposit->order->status == 4)
                                    <span class="badge badge-pill bg--warning">@lang('Pending')</span>
                                @endif
                            </li>
                        </ul>
