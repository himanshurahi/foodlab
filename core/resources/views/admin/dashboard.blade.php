    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['total_restaurants']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Restaurants')</span>
                    </div>
                    <a href="{{route('admin.restaurants.all')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--3 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['verified_restaurants']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Verified Restaurants')</span>
                    </div>
                    <a href="{{route('admin.restaurants.active')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--12 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['email_unverified_restaurants']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Email Unverified Restaurants')</span>
                    </div>

                    <a href="{{route('admin.restaurants.email.unverified')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--6 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['sms_unverified_restaurants']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total SMS Unverified Restaurants')</span>
                    </div>

                    <a href="{{route('admin.restaurants.sms.unverified')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
    </div>
