                ...
                <div class="card-body p-0">
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                            @forelse($restaurants as $user)
                            <tr>
                                <td data-label="@lang('Restaurant')">
                                    <span class="font-weight-bold">{{$user->r_name}}</span>
                                    <br>
                                    <span class="small">
                                    <a href="{{ route('admin.restaurants.detail', $user->id) }}"><span>@</span>{{ $user->username }}</a>
                                    </span>
                                </td>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('admin.restaurants.detail', $user->id) }}" class="icon-btn" data-toggle="tooltip" title="" data-original-title="@lang('Details')">
...
@push('breadcrumb-plugins')
    <form action="{{ route('admin.restaurants.search', $scope ?? str_replace('admin.restaurants.', '', request()->route()->getName())) }}" method="GET" class="form-inline float-sm-right bg--white">
