                            ...
                            @forelse($withdrawals as $withdraw)
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('User')">
                                        ...
                                        @elseif($withdraw->restaurant_id)
                                            <span class="font-weight-bold">{{ $withdraw->restaurant->fullname }}</span>
                                            <br>
                                            <span class="small"> <a href="{{ route('admin.restaurants.detail', $withdraw->restaurant_id) }}"><span>@</span>{{ $withdraw->restaurant->username }}</a> </span>
                                        @endif
                                    </td>
                                    ...
                                    <td data-label="@lang('Type')">
                                        @if ($withdraw->user_id)
                                            <span class="text--small badge font-weight-normal badge--success">@lang('User')</span>
                                        @elseif($withdraw->restaurant_id)
                                            <span class="text--small badge font-weight-normal badge--primary">@lang('Restaurant')</span>
                                        @endif
                                    </td>
