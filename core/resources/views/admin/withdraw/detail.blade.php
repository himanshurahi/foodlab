...
@section('panel')
    <div class="row mb-none-30">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="font-weight-bold">
                                ...
                                @elseif ($withdrawal->restaurant_id)
                                    <a href="{{ route('admin.restaurants.detail', $withdrawal->restaurant_id) }}">{{ @$withdrawal->restaurant->username }}</a>
                                @endif
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        <div class="col-lg-8 col-md-8 mb-30">
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="card-title border-bottom pb-2">@if ($withdrawal->user_id) @lang('User Withdraw Information') @elseif ($withdrawal->restaurant_id) @lang('Restaurant Withdraw Information') @endif</h5>
