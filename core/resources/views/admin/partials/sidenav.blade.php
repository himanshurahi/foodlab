    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.vouchar*')}}">
                    <a href="{{route('admin.vouchar.index')}}" class="nav-link ">
                        <i class="menu-icon las la-gifts"></i>
                        <span class="menu-title">@lang('Vouchar and Offer')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.orders*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.orders.canceled')}} ">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.restaurants*',3)}}">
                        <i class="menu-icon las la-utensils"></i>
                        <span class="menu-title">@lang('Resaturants')</span>

                        @if($banned_restaurants_count > 0 || $email_unverified_restaurants_count > 0 || $sms_unverified_restaurants_count > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.restaurants*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.restaurants.all')}} ">
                                <a href="{{route('admin.restaurants.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Resaturants')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.restaurants.active')}} ">
                                <a href="{{route('admin.restaurants.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Resaturants')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.restaurants.banned')}} ">
                                <a href="{{route('admin.restaurants.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banned Resaturants')</span>
                                    @if($banned_restaurants_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$banned_restaurants_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{menuActive('admin.restaurants.email.unverified')}}">
                                <a href="{{route('admin.restaurants.email.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Email Unverified')</span>

                                    @if($email_unverified_restaurants_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$email_unverified_restaurants_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.restaurants.sms.unverified')}}">
                                <a href="{{route('admin.restaurants.sms.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('SMS Unverified')</span>
                                    @if($sms_unverified_restaurants_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$sms_unverified_restaurants_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.restaurants.with.balance')}}">
                                <a href="{{route('admin.restaurants.with.balance')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('With Balance')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.restaurants.email.all')}}">
                                <a href="{{route('admin.restaurants.email.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Email to All')</span>
                                </a>
                            </li>
