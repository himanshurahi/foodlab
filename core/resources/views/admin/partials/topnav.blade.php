                    ...
                    @foreach($adminNotifications as $notification)
                        ...
                        <div class="navbar-notifi">
                            ...
                            @if ($notification->restaurant_id)
                                <div class="navbar-notifi__left bg--green b-radius--rounded"><img src="{{ getImage(imagePath()['profile']['restaurant']['path'].'/'.@$notification->restaurant->image,imagePath()['profile']['restaurant']['size'])}}" alt="@lang('Profile Image')"></div>
                            @endif
