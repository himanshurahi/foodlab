                            ...
                            @forelse($transactions as $trx)
                                ...
                                <tr>
                                    <td data-label="@lang('User')">
                                        ...
                                        @elseif($trx->restaurant_id)
                                            <span class="font-weight-bold">{{ $trx->restaurant->fullname }}</span>
                                            <br>
                                            <span class="small"> <a href="{{ route('admin.restaurants.detail', $trx->restaurant_id) }}"><span>@</span>{{ $trx->restaurant->username }}</a> </span>
                                        @endif
                                    </td>
